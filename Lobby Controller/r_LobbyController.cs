...
namespace ForceCodeFPS
{
    public class r_LobbyController : MonoBehaviour
    {
        ...
        {
            m_LobbyUI.m_GameInformationText.text = PhotonNetwork.InRoom ? PhotonNetwork.CurrentRoom.CustomProperties["GameMap"].ToString() + " / " + PhotonNetwork.CurrentRoom.CustomProperties["GameMode"].ToString() : "Searching...";
